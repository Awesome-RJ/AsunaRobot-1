...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"AsunaRobot/modules/{shortname}.py")
        name = "AsunaRobot.modules.{}".format(shortname)
        ...
        mod.AsunaRobot = AsunaRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules[f"AsunaRobot.modules.{shortname}"] = mod
        print(f"Successfully imported {shortname}")
